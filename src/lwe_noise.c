...
{ // Fills vector s with n samples from the noise distribution which requires 8 bits to sample. The distribution is specified by its CDF. 
  // Super-constant timing: the CDF table is ingested for every sample.
    size_t rndlen = n;
...
{ // Fills vector s with n samples from the noise distribution which requires 12 bits to sample. The distribution is specified by its CDF. 
  // Super-constant timing: the CDF table is ingested for every sample.
...
{ // Fills vector s with n samples from the noise distribution which requires 16 bits to sample. The distribution is specified by its CDF. 
  // Super-constant timing: the CDF table is ingested for every sample.
    size_t rndlen = 2 * n;
