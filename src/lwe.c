...
*
* Abstract: functions for the kex scheme
*           Instantiates "lwe_macrify.c" with the necessary matrix arithmetic functions
*********************************************************************************************/
...
{ // Round all elements of a vector to the multiple of 2^b, with a hint for the direction of rounding when close to the boundary.
    size_t i;
    uint16_t whole = 1 << b;
...
#define PARAMS_SWITCH_MODULUS (PARAMS_LOG2Q-PARAMS_EXTRACTED_BITS-1)
...
#include "lwe_macrify_reference.c"
#else
